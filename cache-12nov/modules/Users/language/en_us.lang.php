...
If you are not setting up Inbound Email, please clear all fields in that section.',
  ...
  'ERR_USER_IS_LOCKED_OUT' => 'This user is locked out of the litecrm application and cannot log in using his/her existing password.',
  ...
  'LBL_EMAIL_LINK_TYPE_HELP' => '<b>Litecrm Mail Client:</b> Send emails using the email client in the Litecrm application.<br><b>External Mail Client:</b> Send email using an email client outside of the SuiteCRM application, such as Microsoft Outlook.',
  ...
  'LBL_GROUP_DESC' => 'Use for assigning items to a group (example: for Inbound Email).  This type cannot login through the Litecrm web interface.',
  ...
  'LBL_PHONE' => 'Phone',
  'LBL_PICK_TZ_WELCOME' => 'Welcome to Litecrm.',
  ...
  'LBL_PORTAL_ONLY_DESC' => 'Use for the Portal API. This type cannot login through the Litecrm web interface.',
  ...
  'LBL_REMINDER_TEXT' => 'Set a default for reminders for calls and meetings. Pop-up notifications appear for all invitees using Litecrm. Email reminders are sent to all invitees.',
  ...
  'LBL_SETTINGS_URL_DESC' => 'Use this URL when establishing login settings for the SuiteCRM Plug-in for Microsoft&reg; Outlook&reg; and the Litecrm Plug-in for Microsoft&reg; Word&reg;.',
  ...
  'LBL_ICAL_PUB_URL_HELP' => 'Use this URL to subscribe to the Litecrm calendar within iCal.',
  ...
  'LBL_WIZARD_WELCOME_TITLE' => 'Welcome to Litecrm!',
  'LBL_WIZARD_WELCOME' => 'Click <b>Next</b> to configure a few basic settings for using Litecrm.',
  'LBL_WIZARD_WELCOME_NOSMTP' => 'Click <b>Next</b> to configure a few basic settings for using Litecrm.',
  ...
  'LBL_WIZARD_FINISH_TITLE' => 'You are ready to use Litecrm!',
  'LBL_WIZARD_FINISH' => 'Click <b>Finish</b> below to save your settings and to begin using Litecrm. For more information on using Litecrm:<br /><br />
...
<tr><td><!--not_in_theme!-->Visit www.suitecrm.com <img src=include/images/suitecrm_login.png style="margin-right: 5px;"></td><td><a href="http://www.suitecrm.com/" target="_blank"><b>SuiteCRM</b></a></td></tr>
  ...
  'LBL_WIZARD_FINISH2' => 'Start Using Litecrm',
  ...
  'LBL_WIZARD_FINISH11' => 'Visit Litecrm Site ',
  ...
  'LBL_WIZARD_FINISH17' => 'Tips from Litecrm',
  'LBL_WIZARD_FINISH18' => 'Forums ',
  'LBL_WIZARD_FINISH19' => 'Forums dedicated to the Litecrm Community to discuss topics of interest with each other and with Litecrm Developers ',
  ...
  'LBL_WIZARD_PERSONALINFO_DESC' => 'Provide information about yourself. The information you provide about yourself will be visible to other Litecrm users.<br />Fields marked with <span class="required">*</span> are required.',
  'LBL_WIZARD_LOCALE_DESC' => 'Specify your time zone and how you would like dates, currencies and names to appear in Litecrm.',
