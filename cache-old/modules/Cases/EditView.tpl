...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.travelled_before_c.name}" 
id="{$fields.travelled_before_c.name}" 
title=''       
>
{if isset($fields.travelled_before_c.value) && $fields.travelled_before_c.value != ''}
{html_options options=$fields.travelled_before_c.options selected=$fields.travelled_before_c.value}
{else}
{html_options options=$fields.travelled_before_c.options selected=$fields.travelled_before_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.travelled_before_c.options }
{capture name="field_val"}{$fields.travelled_before_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.travelled_before_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.travelled_before_c.name}" 
id="{$fields.travelled_before_c.name}" 
title=''          
>
{if isset($fields.travelled_before_c.value) && $fields.travelled_before_c.value != ''}
...
<input
id="{$fields.travelled_before_c.name}-input"
name="{$fields.travelled_before_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.travelled_before_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.travelled_before_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.travelled_before_c.name}-input', '{$fields.travelled_before_c.name}');sync_{$fields.travelled_before_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.travelled_before_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.travelled_before_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.travelled_before_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.travelled_before_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.travelled_before_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.travelled_before_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.travelled_before_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
<input type="text" name="{$fields.ts_departure_cases_1_name.name}" class="sqsEnabled" tabindex="0" id="{$fields.ts_departure_cases_1_name.name}" size="" value="{$fields.ts_departure_cases_1_name.value}" title='' autocomplete="off"  	 >
<input type="hidden" name="{$fields.ts_departure_cases_1_name.id_name}" 
id="{$fields.ts_departure_cases_1_name.id_name}" 
value="{$fields.ts_departure_cases_1ts_departure_ida.value}">
<span class="id-ff multiple">
<button type="button" name="btn_{$fields.ts_departure_cases_1_name.name}" id="btn_{$fields.ts_departure_cases_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_SELECT_BUTTON_TITLE"}" class="button firstChild" value="{sugar_translate label="LBL_SELECT_BUTTON_LABEL"}"
onclick='open_popup(
"{$fields.ts_departure_cases_1_name.module}", 
600, 
400, 
"", 
true, 
false, 
{literal}{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"ts_departure_cases_1ts_departure_ida","name":"ts_departure_cases_1_name"}}{/literal}, 
"single", 
true
);' ><img src="{sugar_getimagepath file="id-ff-select.png"}"></button><button type="button" name="btn_clr_{$fields.ts_departure_cases_1_name.name}" id="btn_clr_{$fields.ts_departure_cases_1_name.name}" tabindex="0" title="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_TITLE"}"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '{$fields.ts_departure_cases_1_name.name}', '{$fields.ts_departure_cases_1_name.id_name}');"  value="{sugar_translate label="LBL_ACCESSKEY_CLEAR_RELATE_LABEL"}" ><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
<script type="text/javascript">
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['{$form_name}_{$fields.ts_departure_cases_1_name.name}']) != 'undefined'",
		enableQS
);
</script>
...
{/if}  
<input type='text' name='{$fields.office_no_c.name}' id='{$fields.office_no_c.name}' size='30' maxlength='255' value='{$value}' title='' tabindex='0'	  class="phone" >
...
{/if}  
<input type='text' name='{$fields.mobile_c.name}' id='{$fields.mobile_c.name}' size='30' maxlength='255' value='{$value}' title='' tabindex='0'	  class="phone" >
</tr>
{/capture}
{if $fieldsUsed > 0 }
{$tableRow}
...
{/if}  
<input type='text' name='{$fields.adults_c.name}' 
id='{$fields.adults_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
id='{$fields.children_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.baby_c.name}' 
id='{$fields.baby_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.infant_c.name}' 
id='{$fields.infant_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.double_room_c.name}' 
id='{$fields.double_room_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.single_room_c.name}' 
id='{$fields.single_room_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.quad_room_c.name}' 
id='{$fields.quad_room_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.triple_c.name}' 
id='{$fields.triple_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{/if}  
<input type='text' name='{$fields.quint_room_c.name}' 
id='{$fields.quint_room_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
...
{/if}  
<input type='text' name='{$fields.noof_nights_c.name}' 
id='{$fields.noof_nights_c.name}' size='30' 
maxlength='255' 
value='{$value}' title=''      >
</tr>
{/capture}
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.stage_c.name}" 
id="{$fields.stage_c.name}" 
title=''       
>
{if isset($fields.stage_c.value) && $fields.stage_c.value != ''}
{html_options options=$fields.stage_c.options selected=$fields.stage_c.value}
{else}
{html_options options=$fields.stage_c.options selected=$fields.stage_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.stage_c.options }
{capture name="field_val"}{$fields.stage_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.stage_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.stage_c.name}" 
id="{$fields.stage_c.name}" 
title=''          
>
{if isset($fields.stage_c.value) && $fields.stage_c.value != ''}
...
<input
id="{$fields.stage_c.name}-input"
name="{$fields.stage_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.stage_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.stage_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.stage_c.name}-input', '{$fields.stage_c.name}');sync_{$fields.stage_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.stage_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.stage_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.stage_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.stage_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.stage_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.stage_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.stage_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
<span class="dateTime">
{assign var=date_value value=$fields.closing_date_c.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.closing_date_c.name}" id="{$fields.closing_date_c.name}" value="{$date_value}" title=''  tabindex='0'    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.closing_date_c.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
inputField : "{$fields.closing_date_c.name}",
form : "EditView",
ifFormat : "{$CALENDAR_FORMAT}",
daFormat : "{$CALENDAR_FORMAT}",
button : "{$fields.closing_date_c.name}_trigger",
singleClick : true,
dateStr : "{$date_value}",
...
{if !isset($config.enable_autocomplete) || $config.enable_autocomplete==false}
<select name="{$fields.payment_status_c.name}" 
id="{$fields.payment_status_c.name}" 
title=''       
>
{if isset($fields.payment_status_c.value) && $fields.payment_status_c.value != ''}
{html_options options=$fields.payment_status_c.options selected=$fields.payment_status_c.value}
{else}
{html_options options=$fields.payment_status_c.options selected=$fields.payment_status_c.default}
{/if}
</select>
{else}
{assign var="field_options" value=$fields.payment_status_c.options }
{capture name="field_val"}{$fields.payment_status_c.value}{/capture}
{assign var="field_val" value=$smarty.capture.field_val}
{capture name="ac_key"}{$fields.payment_status_c.name}{/capture}
{assign var="ac_key" value=$smarty.capture.ac_key}
<select style='display:none' name="{$fields.payment_status_c.name}" 
id="{$fields.payment_status_c.name}" 
title=''          
>
{if isset($fields.payment_status_c.value) && $fields.payment_status_c.value != ''}
...
<input
id="{$fields.payment_status_c.name}-input"
name="{$fields.payment_status_c.name}-input"
size="30"
value="{$field_val|lookup:$field_options}"
type="text" style="vertical-align: top;">
<span class="id-ff multiple">
<button type="button"><img src="{sugar_getimagepath file="id-ff-down.png"}" id="{$fields.payment_status_c.name}-image"></button><button type="button"
id="btn-clear-{$fields.payment_status_c.name}-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '{$fields.payment_status_c.name}-input', '{$fields.payment_status_c.name}');sync_{$fields.payment_status_c.name}()"><img src="{sugar_getimagepath file="id-ff-clear.png"}"></button>
</span>
{literal}
<script>
	SUGAR.AutoComplete.{/literal}{$ac_key}{literal} = [];
	{/literal}
			...
			{literal}
		(function (){
			var selectElem = document.getElementById("{/literal}{$fields.payment_status_c.name}{literal}");
	...
	SUGAR.AutoComplete.{$ac_key}.inputNode = Y.one('#{$fields.payment_status_c.name}-input');
	SUGAR.AutoComplete.{$ac_key}.inputImage = Y.one('#{$fields.payment_status_c.name}-image');
	SUGAR.AutoComplete.{$ac_key}.inputHidden = Y.one('#{$fields.payment_status_c.name}');
			...
			//global variable 
			sync_{/literal}{$fields.payment_status_c.name}{literal} = function(){
				SyncToHidden();
			}
			function syncFromHiddenToWidget(){
				...
				for (i=0;i<selectElem.options.length;i++){
					...
					if (selectElem.options[i].value==selectElem.value && document.activeElement != document.getElementById('{/literal}{$fields.payment_status_c.name}-input{literal}'))
						SUGAR.AutoComplete.{/literal}{$ac_key}{literal}.inputNode.set('value',selectElem.options[i].innerHTML);
				}
			}

            YAHOO.util.Event.onAvailable("{/literal}{$fields.payment_status_c.name}{literal}", syncFromHiddenToWidget);
		{/literal}
...
{if strlen($fields.balance_due_c.value) <= 0}
{assign var="value" value=$fields.balance_due_c.default_value }
{else}
{assign var="value" value=$fields.balance_due_c.value }
{/if}  
<input type='text' name='{$fields.balance_due_c.name}' 
id='{$fields.balance_due_c.name}' size='30' maxlength='26' value='{sugar_number_format var=$value}' title='' tabindex='0'
>
</tr>
{/capture}
{if $fieldsUsed > 0 }
...
addToValidate('EditView', 'adults_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_ADULTS' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'triple_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TRIPLE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'children_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_CHILDREN' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'mobile_c', 'phone', false,'{/literal}{sugar_translate label='LBL_MOBILE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'stage_c', 'enum', false,'{/literal}{sugar_translate label='LBL_STAGE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'infant_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_INFANT' module='Cases' for_js=true}{literal}' );
...
addToValidate('EditView', 'single_room_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_SINGLE_ROOM' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'travelled_before_c', 'enum', false,'{/literal}{sugar_translate label='LBL_TRAVELLED_BEFORE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'baby_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_BABY' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'noof_nights_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_NOOF_NIGHTS' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'campaign_source_c', 'relate', false,'{/literal}{sugar_translate label='LBL_CAMPAIGN_SOURCE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'balance_due_c', 'currency', false,'{/literal}{sugar_translate label='LBL_BALANCE_DUE' module='Cases' for_js=true}{literal}' );
...
addToValidate('EditView', 'closing_date_c', 'date', false,'{/literal}{sugar_translate label='LBL_CLOSING_DATE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'quint_room_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_QUINT_ROOM' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'ts_departure_cases_1_name', 'relate', false,'{/literal}{sugar_translate label='LBL_TS_DEPARTURE_CASES_1_FROM_TS_DEPARTURE_TITLE' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'office_no_c', 'phone', false,'{/literal}{sugar_translate label='LBL_OFFICE_NO' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'currency_id', 'currency_id', false,'{/literal}{sugar_translate label='LBL_CURRENCY' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'quad_room_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_QUAD_ROOM' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'payment_status_c', 'enum', false,'{/literal}{sugar_translate label='LBL_PAYMENT_STATUS' module='Cases' for_js=true}{literal}' );
...
addToValidate('EditView', 'double_room_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_DOUBLE_ROOM' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'amount_c', 'currency', false,'{/literal}{sugar_translate label='LBL_AMOUNT' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'campaign_id_c', 'id', false,'{/literal}{sugar_translate label='LBL_CAMPAIGN_SOURCE_CAMPAIGN_ID' module='Cases' for_js=true}{literal}' );
addToValidate('EditView', 'lead_source_c', 'enum', false,'{/literal}{sugar_translate label='LBL_LEAD_SOURCE' module='Cases' for_js=true}{literal}' );
