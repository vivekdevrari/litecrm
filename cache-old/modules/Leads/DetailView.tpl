...
<span id="account_id_c" class="sugar_field" data-id-value="{$fields.account_id_c.value}">{$fields.company_c.value}</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TRAVELLED_BEFORE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.skype_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_SKYPE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.skype_c.value) <= 0}
{assign var="value" value=$fields.skype_c.default_value }
{else}
{assign var="value" value=$fields.skype_c.value }
{/if} 
<span class="sugar_field" id="{$fields.skype_c.name}">{$fields.skype_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_ADULTS' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.childrens_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_CHILDRENS' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.childrens_c.value) <= 0}
{assign var="value" value=$fields.childrens_c.default_value }
{else}
{assign var="value" value=$fields.childrens_c.value }
{/if} 
<span class="sugar_field" id="{$fields.childrens_c.name}">{$fields.childrens_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{capture name="label" assign="label"}{sugar_translate label='LBL_BABY' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_INFANT' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.double_rooms_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_DOUBLE_ROOMS' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.double_rooms_c.value) <= 0}
{assign var="value" value=$fields.double_rooms_c.default_value }
{else}
{assign var="value" value=$fields.double_rooms_c.value }
{/if} 
<span class="sugar_field" id="{$fields.double_rooms_c.name}">{$fields.double_rooms_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.single_rooms_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_SINGLE_ROOMS' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.single_rooms_c.value) <= 0}
{assign var="value" value=$fields.single_rooms_c.default_value }
{else}
{assign var="value" value=$fields.single_rooms_c.value }
{/if} 
<span class="sugar_field" id="{$fields.single_rooms_c.name}">{$fields.single_rooms_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
</tr>
{/capture}
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.triple_room_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_TRIPLE_ROOM' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if strlen($fields.triple_room_c.value) <= 0}
{assign var="value" value=$fields.triple_room_c.default_value }
{else}
{assign var="value" value=$fields.triple_room_c.value }
{/if} 
<span class="sugar_field" id="{$fields.triple_room_c.name}">{$fields.triple_room_c.value}</span>
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.quad_room_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_QUAD_ROOM' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_QUINT_ROOM' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_NOOF_NIGHTS' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.fixed_departure_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_FIXED_DEPARTURE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{if !empty($fields.ts_departure_id_c.value)}
{capture assign="detail_url"}index.php?module=ts_Departure&action=DetailView&record={$fields.ts_departure_id_c.value}{/capture}
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="ts_departure_id_c" class="sugar_field" data-id-value="{$fields.ts_departure_id_c.value}">{$fields.fixed_departure_c.value}</span>
{if !empty($fields.ts_departure_id_c.value)}</a>{/if}
{/if}
<div class="inlineEditIcon"> {sugar_getimage name="inline_edit_icon.svg" attr='border="0" ' alt="$alt_edit"}</div>			</td>
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
...
{sugar_translate label='LBL_EDITVIEW_PANEL2' module='Leads'}
<script>
...
{counter name="fieldsUsed"}
<td width='12.5%' scope="col">
{if !$fields.interested_in_c.hidden}
{capture name="label" assign="label"}{sugar_translate label='LBL_INTERESTED_IN' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
<a href="{sugar_ajax_url url=$detail_url}">{/if}
<span id="aos_products_id_c" class="sugar_field" data-id-value="{$fields.aos_products_id_c.value}">{$fields.interested_in_c.value}</span>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TRIP_START_DATE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
...
{capture name="label" assign="label"}{sugar_translate label='LBL_TRIP_END_DATE' module='Leads'}{/capture}
{$label|strip_semicolon}:
{/if}
</td>
