<?php 
 $GLOBALS["dictionary"]["ts_Vendors"]=array (
  'table' => 'ts_vendors',
  'audited' => true,
  'inline_edit' => true,
  ...
  array (
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ts_vendors_created_by',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ts_vendors_modified_user',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ts_vendors_assigned_user',
    ...
    array (
      'name' => 'SecurityGroups',
      'type' => 'link',
      'relationship' => 'securitygroups_ts_vendors',
    ...
    'ts_vendors_type' => 
    array (
      'name' => 'ts_vendors_type',
      'vname' => 'LBL_TYPE',
      'type' => 'enum',
      'options' => 'ts_vendors_type_dom',
      'len' => 50,
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ts_vendors_email_addresses_primary',
      'source' => 'non-db',
    ...
    array (
      ...
      'type' => 'link',
      'relationship' => 'ts_vendors_email_addresses',
      'source' => 'non-db',
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Vendor Category',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'vendor_category_c',
      'vname' => 'LBL_VENDOR_CATEGORY',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'vendor_category_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'ts_Vendorsvendor_category_c',
      'custom_module' => 'ts_Vendors',
    ),
    'cases_ts_vendors_1' => 
    array (
    ...
    'ts_departure_ts_vendors_1_name' => 
    array (
    ...
    'ts_departure_ts_vendors_1ts_departure_ida' => 
    array (
