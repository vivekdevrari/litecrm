<?php /* Smarty version 2.6.29, created on 2016-10-18 02:31:09
         compiled from cache/modules/ts_Passenger/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/ts_Passenger/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/ts_Passenger/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/ts_Passenger/SearchForm_basic.tpl', 44, false),array('function', 'sugar_getimagepath', 'cache/modules/ts_Passenger/SearchForm_basic.tpl', 102, false),array('modifier', 'count', 'cache/modules/ts_Passenger/SearchForm_basic.tpl', 89, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='search_name_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'ts_Passenger'), $this);?>
</label>
    	</td>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='email_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_ANY_EMAIL','module' => 'ts_Passenger'), $this);?>
</label>
    	</td>
...
</script><?php echo '<script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'search_form_modified_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["modified_by_name_basic","modified_user_id_basic"],"required_list":["modified_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_created_by_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["created_by_name_basic","created_by_basic"],"required_list":["created_by"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_assigned_user_name_basic\']={"form":"search_form","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name_basic","assigned_user_id_basic"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_passenger_name_c_basic\']={"form":"search_form","method":"get_contact_array","modules":["Contacts"],"field_list":["salutation","first_name","last_name","id"],"populate_list":["passenger_name_c_basic","contact_id_c_basic","contact_id_c_basic","contact_id_c_basic"],"required_list":["contact_id_c"],"group":"or","conditions":[{"name":"first_name","op":"like_custom","end":"%","value":""},{"name":"last_name","op":"like_custom","end":"%","value":""}],"order":"last_name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_trip_name_c_basic\']={"form":"search_form","method":"query","modules":["Cases"],"group":"or","field_list":["name","id"],"populate_list":["trip_name_c_basic","acase_id_c_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'search_form_cases_ts_passenger_1_name_basic\']={"form":"search_form","method":"query","modules":["Cases"],"group":"or","field_list":["name","id"],"populate_list":["cases_ts_passenger_1_name_basic","cases_ts_passenger_1cases_ida_basic"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};</script>'; ?>