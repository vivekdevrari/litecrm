<?php /* Smarty version 2.6.29, created on 2016-10-22 08:25:37
         compiled from cache/modules/ts_Passenger/EditView.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'cache/modules/ts_Passenger/EditView.tpl', 38, false),array('modifier', 'default', 'cache/modules/ts_Passenger/EditView.tpl', 49, false),array('modifier', 'strip_semicolon', 'cache/modules/ts_Passenger/EditView.tpl', 67, false),array('modifier', 'lookup', 'cache/modules/ts_Passenger/EditView.tpl', 345, false),array('modifier', 'count', 'cache/modules/ts_Passenger/EditView.tpl', 447, false),array('function', 'sugar_include', 'cache/modules/ts_Passenger/EditView.tpl', 44, false),array('function', 'counter', 'cache/modules/ts_Passenger/EditView.tpl', 50, false),array('function', 'sugar_getimagepath', 'cache/modules/ts_Passenger/EditView.tpl', 53, false),array('function', 'sugar_translate', 'cache/modules/ts_Passenger/EditView.tpl', 56, false),array('function', 'html_options', 'cache/modules/ts_Passenger/EditView.tpl', 320, false),)), $this); ?>
...
" accessKey="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_KEY']; ?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=ts_Passenger'); return false;" type="button" name="button" value="<?php echo $this->_tpl_vars['APP']['LBL_CANCEL_BUTTON_LABEL']; ?>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_INFORMATION','module' => 'ts_Passenger'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='trip_name_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TRIP_NAME','module' => 'ts_Passenger'), $this);?>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['trip_name_c']['value']; ?>
" title='' autocomplete="off"  	 accesskey='7'  >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['trip_name_c']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['trip_name_c']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['acase_id_c']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['trip_name_c']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"acase_id_c","name":"trip_name_c"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['trip_name_c']['id_name']; ?>
...
_<?php echo $this->_tpl_vars['fields']['trip_name_c']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
<td valign="top" id='cases_ts_passenger_1_name_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CASES_TS_PASSENGER_1_FROM_CASES_TITLE','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<input type="text" name="<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
" class="sqsEnabled" tabindex="0" id="<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
" size="" value="<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['value']; ?>
" title='' autocomplete="off"  	 >
<input type="hidden" name="<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['id_name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['id_name']; ?>
" 
value="<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1cases_ida']['value']; ?>
">
<span class="id-ff multiple">
<button type="button" name="btn_<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
" id="btn_<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_TITLE'), $this);?>
" class="button firstChild" value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SELECT_BUTTON_LABEL'), $this);?>
"
onclick='open_popup(
"<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['module']; ?>
", 
600, 
400, 
"", 
true, 
false, 
<?php echo '{"call_back_function":"set_return","form_name":"EditView","field_to_name_array":{"id":"cases_ts_passenger_1cases_ida","name":"cases_ts_passenger_1_name"}}'; ?>
, 
"single", 
true
);' ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-select.png"), $this);?>
"></button><button type="button" name="btn_clr_<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
" id="btn_clr_<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
" tabindex="0" title="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_TITLE'), $this);?>
"  class="button lastChild"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
', '<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['id_name']; ?>
');"  value="<?php echo smarty_function_sugar_translate(array('label' => 'LBL_ACCESSKEY_CLEAR_RELATE_LABEL'), $this);?>
" ><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
...
SUGAR.util.doWhen(
		"typeof(sqs_objects) != 'undefined' && typeof(sqs_objects['<?php echo $this->_tpl_vars['form_name']; ?>
_<?php echo $this->_tpl_vars['fields']['cases_ts_passenger_1_name']['name']; ?>
']) != 'undefined'",
		enableQS
);
</script>
...
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DESCRIPTION','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EMAIL_ADDRESSES','module' => 'ts_Passenger'), $this);?>
...
"></a>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_EDITVIEW_PANEL1','module' => 'ts_Passenger'), $this);?>
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='passenger_role_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_PASSENGER_ROLE','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<select name="<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['passenger_role_c']['value'] ) && $this->_tpl_vars['fields']['passenger_role_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['passenger_role_c']['options'],'selected' => $this->_tpl_vars['fields']['passenger_role_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['passenger_role_c']['options'],'selected' => $this->_tpl_vars['fields']['passenger_role_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['passenger_role_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['passenger_role_c']['value']; ?>
...
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
-input"
size="30"
...
id="btn-clear-<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
<?php echo '");
...
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['passenger_role_c']['name']; ?>
');
...
<?php endif; ?>
<td valign="top" id='departure_gateway_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEPARTURE_GATEWAY','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['departure_gateway_c']['value'] ) && $this->_tpl_vars['fields']['departure_gateway_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['departure_gateway_c']['options'],'selected' => $this->_tpl_vars['fields']['departure_gateway_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['departure_gateway_c']['options'],'selected' => $this->_tpl_vars['fields']['departure_gateway_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['departure_gateway_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['departure_gateway_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['departure_gateway_c']['name']; ?>
');
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='airline_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AIRLINE','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (! isset ( $this->_tpl_vars['config']['enable_autocomplete'] ) || $this->_tpl_vars['config']['enable_autocomplete'] == false): ?>
<select name="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
" 
title=''       
>
<?php if (isset ( $this->_tpl_vars['fields']['airline_c']['value'] ) && $this->_tpl_vars['fields']['airline_c']['value'] != ''): ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['airline_c']['options'],'selected' => $this->_tpl_vars['fields']['airline_c']['value']), $this);?>

<?php else: ?>
<?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['fields']['airline_c']['options'],'selected' => $this->_tpl_vars['fields']['airline_c']['default']), $this);?>

<?php endif; ?>
</select>
<?php else: ?>
<?php $this->assign('field_options', $this->_tpl_vars['fields']['airline_c']['options']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['airline_c']['value']; ?>
<?php $this->_smarty_vars['capture']['field_val'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('field_val', $this->_smarty_vars['capture']['field_val']); ?>
<?php ob_start(); ?><?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
<?php $this->_smarty_vars['capture']['ac_key'] = ob_get_contents(); ob_end_clean(); ?>
<?php $this->assign('ac_key', $this->_smarty_vars['capture']['ac_key']); ?>
<select style='display:none' name="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
" 
id="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
" 
title=''          
...
id="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-input"
name="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-input"
size="30"
value="<?php echo ((is_array($_tmp=$this->_tpl_vars['field_val'])) ? $this->_run_mod_handler('lookup', true, $_tmp, $this->_tpl_vars['field_options']) : smarty_modifier_lookup($_tmp, $this->_tpl_vars['field_options'])); ?>
"
...
" id="<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-image"></button><button type="button"
id="btn-clear-<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-input"
title="Clear"
onclick="SUGAR.clearRelateField(this.form, '<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-input', '<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
');sync_<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
()"><img src="<?php echo smarty_function_sugar_getimagepath(array('file' => "id-ff-clear.png"), $this);?>
"></button>
</span>
<?php echo '
...
<?php echo ' = [];
	'; ?>
		...
		(function (){
			var selectElem = document.getElementById("'; ?>
<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
<?php echo '");
...
<?php echo '.ds = new Y.DataSource.Function({
	...
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputNode = Y.one('#<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-input');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputImage = Y.one('#<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
-image');
	SUGAR.AutoComplete.<?php echo $this->_tpl_vars['ac_key']; ?>
.inputHidden = Y.one('#<?php echo $this->_tpl_vars['fields']['airline_c']['name']; ?>
');
...
<?php endif; ?>
<td valign="top" id='air_ticket_no_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_AIR_TICKET_NO','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['air_ticket_no_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['air_ticket_no_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['air_ticket_no_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['air_ticket_no_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['air_ticket_no_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
<?php ob_start(); ?>
<tr>
<td valign="top" id='deviations_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DEVIATIONS','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['deviations_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['deviations_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['deviations_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['deviations_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['deviations_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
<td valign="top" id='special_request_c_label' width='12.5%' scope="col">
<?php ob_start(); ?><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SPECIAL_REQUEST','module' => 'ts_Passenger'), $this);?>
<?php $this->_smarty_vars['capture']['label'] = ob_get_contents();  $this->assign('label', ob_get_contents());ob_end_clean(); ?>
<?php echo ((is_array($_tmp=$this->_tpl_vars['label'])) ? $this->_run_mod_handler('strip_semicolon', true, $_tmp) : smarty_modifier_strip_semicolon($_tmp)); ?>
:
</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['special_request_c']['value'] ) <= 0): ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['special_request_c']['default_value']); ?>
<?php else: ?>
<?php $this->assign('value', $this->_tpl_vars['fields']['special_request_c']['value']); ?>
<?php endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['special_request_c']['name']; ?>
' 
id='<?php echo $this->_tpl_vars['fields']['special_request_c']['name']; ?>
' size='30' 
maxlength='255' 
value='<?php echo $this->_tpl_vars['value']; ?>
' title=''      >
...
addToValidateBinaryDependency(\'EditView\', \'trip_name_c\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'ts_Passenger','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TRIP_NAME','module' => 'ts_Passenger','for_js' => true), $this);?>
<?php echo '\', \'acase_id_c\' );
addToValidateBinaryDependency(\'EditView\', \'cases_ts_passenger_1_name\', \'alpha\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'ERR_SQS_NO_MATCH_FIELD','module' => 'ts_Passenger','for_js' => true), $this);?>
<?php echo ': '; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CASES_TS_PASSENGER_1_FROM_CASES_TITLE','module' => 'ts_Passenger','for_js' => true), $this);?>
<?php echo '\', \'cases_ts_passenger_1cases_ida\' );
</script><script language="javascript">if(typeof sqs_objects == \'undefined\'){var sqs_objects = new Array;}sqs_objects[\'EditView_trip_name_c\']={"form":"EditView","method":"query","modules":["Cases"],"group":"or","field_list":["name","id"],"populate_list":["trip_name_c","acase_id_c"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_cases_ts_passenger_1_name\']={"form":"EditView","method":"query","modules":["Cases"],"group":"or","field_list":["name","id"],"populate_list":["cases_ts_passenger_1_name","cases_ts_passenger_1cases_ida"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"No Match"};sqs_objects[\'EditView_assigned_user_name\']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"No Match"};</script>'; ?>
