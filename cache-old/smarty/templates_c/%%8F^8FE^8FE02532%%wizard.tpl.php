<?php /* Smarty version 2.6.29, created on 2016-10-25 11:56:59
                            ...
                            <td scope="row">
                                ...
                                <table cellpadding=0 cellspacing=0><input id='whatnext' name='whatnext' type="hidden" value='finish' />
                                    ...
                                    <?php else: ?>
                                        ...
                                        <tr><td colspan=2><hr style="margin: 5px 0px;"></td></tr>
                                        <tr><td><img src=include/images/docs.png style="margin-right: 5px;"></td><td><a href="https://suitecrm.com/wiki/index.php/Userguide" target="_blank"><b> <?php echo $this->_tpl_vars['MOD']['LBL_WIZARD_FINISH14']; ?>
