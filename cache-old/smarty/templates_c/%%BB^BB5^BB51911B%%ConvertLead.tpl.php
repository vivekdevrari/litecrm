...
" style="position:relative; top:6px" border="0" id="Meetingsdate_start_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
