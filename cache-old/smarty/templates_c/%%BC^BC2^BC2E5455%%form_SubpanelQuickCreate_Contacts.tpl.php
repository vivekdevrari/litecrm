<?php /* Smarty version 2.6.29, created on 2016-10-26 05:57:21
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'contact_type_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_CONTACT_TYPE','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'passport_issue_c\', \'date\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_ISSUE','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'date_anniversary_c\', \'date\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_DATE_ANNIVERSARY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'preferred_seat_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PREFERRED_SEAT','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'passport_no_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_NO','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'name_tag_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME_TAG','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'nationality_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_NATIONALITY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'preferred_meal_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PREFERRED_MEAL','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'travelled_before_c\', \'enum\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_TRAVELLED_BEFORE','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'skype_id_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_SKYPE_ID','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'medical_details_c\', \'varchar\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_MEDICAL_DETAILS','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
...
<?php echo '\' );
addToValidate(\'form_SubpanelQuickCreate_Contacts\', \'passport_expiry_c\', \'date\', false,\''; ?>
<?php echo smarty_function_sugar_translate(array('label' => 'LBL_PASSPORT_EXPIRY','module' => 'Contacts','for_js' => true), $this);?>
<?php echo '\' );
