<?php 
 $GLOBALS["dictionary"]["Contact"]=array (
  ...
  array (
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Passport Date of Issue',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'passport_issue_c',
      'vname' => 'LBL_PASSPORT_ISSUE',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'id' => 'Contactspassport_issue_c',
      'custom_module' => 'Contacts',
    ),
    'date_anniversary_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Date of Anniversary',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'date_anniversary_c',
      'vname' => 'LBL_DATE_ANNIVERSARY',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'size' => '20',
      'enable_range_search' => false,
      'id' => 'Contactsdate_anniversary_c',
      'custom_module' => 'Contacts',
    ),
    'preferred_seat_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Preferred In-Flight Seat',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'preferred_seat_c',
      'vname' => 'LBL_PREFERRED_SEAT',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'preferred_seat_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactspreferred_seat_c',
      'custom_module' => 'Contacts',
    ),
    'cases_contacts_1' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactsnationality_c',
      'custom_module' => 'Contacts',
    ),
    'preferred_meal_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Preferred Meal',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'preferred_meal_c',
      'vname' => 'LBL_PREFERRED_MEAL',
      'type' => 'enum',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
      ...
      'len' => 100,
      'size' => '20',
      'options' => 'preferred_meal_list',
      'studio' => 'visible',
      'dependency' => false,
      'id' => 'Contactspreferred_meal_c',
      'custom_module' => 'Contacts',
    ),
    'jjwg_maps_lat_c' => 
    array (
    ...
    array (
      ...
      'len' => '255',
      'size' => '20',
      'id' => 'Contactsskype_id_c',
      'custom_module' => 'Contacts',
    ),
    'medical_details_c' => 
    array (
      'inline_edit' => '1',
      'labelValue' => 'Medical Details',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'medical_details_c',
      'vname' => 'LBL_MEDICAL_DETAILS',
      'type' => 'varchar',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
    ...
    array (
      'inline_edit' => '1',
      'labelValue' => 'Passport Date of Expiry',
      'required' => false,
      'source' => 'custom_fields',
      'name' => 'passport_expiry_c',
      'vname' => 'LBL_PASSPORT_EXPIRY',
      'type' => 'date',
      'massupdate' => '0',
      'default' => '',
      'no_default' => false,
