...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='document_name_advanced'>{sugar_translate label='LBL_NAME' module='Tour_Tour'}</label>
		</td>
...
<input type='text' name='{$fields.document_name_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='category_id_advanced'>{sugar_translate label='LBL_SF_CATEGORY' module='Tour_Tour'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='category_id_advanced' name='category_id_advanced[]' options=$fields.category_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.category_id_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='subcategory_id_advanced'>{sugar_translate label='LBL_SF_SUBCATEGORY' module='Tour_Tour'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
{html_options id='subcategory_id_advanced' name='subcategory_id_advanced[]' options=$fields.subcategory_id_advanced.options size="6" style="width: 150px" multiple="1" selected=$fields.subcategory_id_advanced.value}
   	   	</td>
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='active_date_advanced'>{sugar_translate label='LBL_DOC_ACTIVE_DATE' module='Tour_Tour'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<span class="dateTime">
{assign var=date_value value=$fields.active_date_advanced.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.active_date_advanced.name}" id="{$fields.active_date_advanced.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.active_date_advanced.name}_trigger"{/capture}
...
{rdelim}
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='exp_date_advanced'>{sugar_translate label='LBL_DOC_EXP_DATE' module='Tour_Tour'}</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<span class="dateTime">
{assign var=date_value value=$fields.exp_date_advanced.value }
<input class="date_input" autocomplete="off" type="text" name="{$fields.exp_date_advanced.name}" id="{$fields.exp_date_advanced.name}" value="{$date_value}" title=''  tabindex=''    size="11" maxlength="10" >
{capture assign="other_attributes"}alt="{$APP.LBL_ENTER_DATE}" style="position:relative; top:6px" border="0" id="{$fields.exp_date_advanced.name}_trigger"{/capture}
{sugar_getimage name="jscalendar" ext=".gif" other_attributes="$other_attributes"}
</span>
<script type="text/javascript">
Calendar.setup ({ldelim}
