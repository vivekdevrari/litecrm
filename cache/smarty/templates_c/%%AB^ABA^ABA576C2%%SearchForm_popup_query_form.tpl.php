<?php /* Smarty version 2.6.29, created on 2016-12-18 14:54:08
         compiled from cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 26, false),array('function', 'math', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 44, false),array('function', 'html_options', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 83, false),array('function', 'sugar_getimage', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 141, false),array('modifier', 'default', 'cache/modules/Tour_Tour/SearchForm_popup_query_form.tpl', 152, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='document_name_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'Tour_Tour'), $this);?>
</label>
		</td>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='category_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SF_CATEGORY','module' => 'Tour_Tour'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'category_id_advanced','name' => 'category_id_advanced[]','options' => $this->_tpl_vars['fields']['category_id_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['category_id_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='subcategory_id_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_SF_SUBCATEGORY','module' => 'Tour_Tour'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
			
<?php echo smarty_function_html_options(array('id' => 'subcategory_id_advanced','name' => 'subcategory_id_advanced[]','options' => $this->_tpl_vars['fields']['subcategory_id_advanced']['options'],'size' => '6','style' => "width: 150px",'multiple' => '1','selected' => $this->_tpl_vars['fields']['subcategory_id_advanced']['value']), $this);?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='active_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DOC_ACTIVE_DATE','module' => 'Tour_Tour'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['active_date_advanced']['name']; ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='10%' >
			<label for='exp_date_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_DOC_EXP_DATE','module' => 'Tour_Tour'), $this);?>
</label>
		</td>
	<td  nowrap="nowrap" width='30%'>
...
" title=''  tabindex=''    size="11" maxlength="10" >
<?php ob_start(); ?>alt="<?php echo $this->_tpl_vars['APP']['LBL_ENTER_DATE']; ?>
" style="position:relative; top:6px" border="0" id="<?php echo $this->_tpl_vars['fields']['exp_date_advanced']['name']; ?>
_trigger"<?php $this->_smarty_vars['capture']['default'] = ob_get_contents();  $this->assign('other_attributes', ob_get_contents());ob_end_clean(); ?>
<?php echo smarty_function_sugar_getimage(array('name' => 'jscalendar','ext' => ".gif",'other_attributes' => ($this->_tpl_vars['other_attributes'])), $this);?>
