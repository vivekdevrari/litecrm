 ...
 * PLACE ANY CUSTOMIZATIONS IN ts_Passenger
 */

require_once('include/SugarObjects/templates/person/Person.php');

class ts_Passenger_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'ts_Passenger';
	var $object_name = 'ts_Passenger';
	var $table_name = 'ts_passenger';
