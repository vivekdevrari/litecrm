 ...
 * PLACE ANY CUSTOMIZATIONS IN TD_Tour_Details
 */

require_once('include/SugarObjects/templates/person/Person.php');

class TD_Tour_Details_sugar extends Person {
	var $new_schema = true;
	var $module_dir = 'TD_Tour_Details';
	var $object_name = 'TD_Tour_Details';
	var $table_name = 'td_tour_details';
	var $importable = true;
