 ...
 * PLACE ANY CUSTOMIZATIONS IN ts_Vendors
 */

require_once('include/SugarObjects/templates/company/Company.php');

class ts_Vendors_sugar extends Company {
	var $new_schema = true;
	var $module_dir = 'ts_Vendors';
	var $object_name = 'ts_Vendors';
	var $table_name = 'ts_vendors';
	var $importable = true;
